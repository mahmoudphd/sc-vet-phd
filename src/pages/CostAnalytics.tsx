...
export const simulatedIoTCostData = {
  ...
  directLabor: [
    { name: 'Operator', hours: 2, hourlyRate: 1, cost: 2 },
    { name: 'Supervisor', hours: 2, hourlyRate: 0.3, cost: 0.6 },
    { name: 'Quality Control', hours: 1, hourlyRate: 0.4, cost: 0.4 },
  ],
  overheadItems: [
    { name: 'Rent', totalCost: 1000, basis: 1000, cost: 1 },
    { name: 'Electricity', totalCost: 500, basis: 1000, cost: 0.5 },
    { name: 'Maintenance', totalCost: 1000, basis: 1000, cost: 0.5 },
  ],
  otherCosts: [
    { name: 'Transportation', qty: 1, unitPrice: 7, cost: 7 },
    { name: 'Packaging Waste Disposal', qty: 1, unitPrice: 4, cost: 4 },
    { name: 'Rework', qty: 1, unitPrice: 4, cost: 4 },
  ],
};
