...
const CO2Footprint = () => {
  ...
  const reductionData = [
    {
      ...
      description: 'Renewable energy for facilities',
      impact: 'High',
      reduction: 2.5,
    },
    {
      initiative: 'LED Lighting',
      description: 'Efficient factory/office lighting',
      impact: 'Medium',
      reduction: 1.2,
    },
    {
      initiative: 'Industrial Waste Recycling',
      description: 'Less landfill/burning emissions',
      impact: 'Medium',
      reduction: 1.5,
    },
    {
      initiative: 'Fuel Consumption Optimization',
      description: 'Efficient transport/logistics',
      impact: 'Medium',
      reduction: 1.3,
    },
  ];
  ...
  const totalReduction = reductionData.reduce(
        ...
        <Flex gap="3">
          <Box style={{ width: 180 }}>
            ...
            >
              <Select.Trigger />
              <Select.Content>
                <Select.Item value="Poultry Product 1">
                  Poultry Product 1
                </Select.Item>
              </Select.Content>
            </Select.Root>
          ...
          <Box style={{ width: 100 }}>
            <Select.Root
              value={currency}
              onValueChange={(val) => setCurrency(val as 'USD' | 'EGP')}
            >
              <Select.Trigger />
              <Select.Content>
      ...
      <Grid columns="4" gap="4" mb="5">
        ...
        <Card>
          <Flex direction="column" gap="1" p="4">
            ...
            <Heading size="7">
              {carbonIntensity.toFixed(2)} t/{currency === 'USD' ? '$K' : 'EGP K'}
            </Heading>
        ...
        <Card>
          <Flex direction="column" gap="1" p="4">
            ...
            <Text size="1" color="gray">
              Estimated reduction from active initiatives
            </Text>
          </Flex>
        </Card>
      </Grid>
              ...
              <PieChart>
                ...
                >
                  {emissionDataWithPercent.map((entry, index) => (
                    <Cell
                      key={`cell-${index}`}
                      fill={['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#6366f1', '#22c55e', '#a855f7'][
                        index % 7
                      ]}
                    />
                  ))}
      ...
      <Table.Root variant="surface">
        ...
        <Table.Body>
          ...
          <Table.Row>
            ...
            <Table.Cell>
              <strong>{totalEmissions.toFixed(1)}</strong>
            </Table.Cell>
            <Table.Cell>
              <strong>100%</strong>
            </Table.Cell>
            <Table.Cell>
              <strong>{(totalEmissions * 0.8).toFixed(1)} tCO₂e</strong>
            </Table.Cell>
            <Table.Cell />
            <Table.Cell />
          </Table.Row>
